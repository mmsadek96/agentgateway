# AgentTrust Gateway - Replit Template

Deploy a trust-verified AI agent gateway on Replit in one click. This template creates an Express server with the `@agent-trust/gateway` middleware, pre-configured with a demo product catalog that AI agents can interact with using cryptographic certificates.
...
Set these in your Replit Secrets (padlock icon in the sidebar):
